...
get_loglike=function(t.NUMA, t.nchrno, t.G, t.L, t.kLL, t.max.donors, t.NUMP, t.ndonors, t.donates, t.donatesl, t.transitions, t.maxmatchsize, t.umatch, t.flips,
  ...
  for (ch in 1:t.nchrno) 
  {
	...
	cppforward(k,t.NUMA,t.max.donors,THIN,t.NUMP,t.kLL,t.L,0,t.G[ch],t.G[ch],t.transitions[[ind]],t.umatch[[ch]],t.maxmatchsize[ch],d.w[[ch]],t.w[[ch]],gobs[[ch]][[ind]],
		   t.mutmat,t.maxmiss,t.initProb[k,],label,t.ndonors[[ch]][[ind]],donates_chr[[ind]],donatesl_chr[[ind]],t.flips[[ind]][[ch]],t.fors,t.sumfors,t.scalefactor)
	...
	t.fors<-rep(0,t.G[ch]*t.max.donors*t.L);t.sumfors<-matrix(0,t.G[ch],t.L);t.scalefactor<-rep(0,t.G[ch]);
	cppforward(k,t.NUMA,t.max.donors,THIN,t.NUMP,t.kLL,t.L,0,t.G[ch],t.G[ch],t.transitions[[ind]],t.umatch[[ch]],t.maxmatchsize[ch],d.w[[ch]],t.w[[ch]],gobs[[ch]][[ind]],
		   t.mutmat,t.maxmiss,t.initProb[k,],label,t.ndonors[[ch]][[ind]],donates_chr_ind,donatesl_chr_ind,t.flips[[ind]][[ch]],t.fors,t.sumfors,t.scalefactor)
	-sum(log(t.scalefactor))
      }
    }
    if (!HPC)
	...
	t.fors<-rep(0,t.G[ch]*t.max.donors*t.L);t.sumfors<-matrix(0,t.G[ch],t.L);t.scalefactor<-rep(0,t.G[ch]);
	cppforward(k,t.NUMA,t.max.donors,THIN,t.NUMP,t.kLL,t.L,0,t.G[ch],t.G[ch],t.transitions[[ind]],t.umatch[[ch]],t.maxmatchsize[ch],d.w[[ch]],t.w[[ch]],gobs[[ch]][[ind]],
		   t.mutmat,t.maxmiss,t.initProb[k,],label,t.ndonors[[ch]][[ind]],t.donates[[ch]][[ind]],t.donatesl[[ch]][[ind]],t.flips[[ind]][[ch]],t.fors,t.sumfors,t.scalefactor)
	-sum(log(t.scalefactor))
      }
    }
