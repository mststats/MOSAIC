...
admix_genomes=function(t.chrnos, t.ch, t.NUMA, t.NUMP, t.KNOWN, t.NN, t.multipanels, t.L, t.S, t.G, t.nl, t.kLL) {
  ...
  for (k in (t.NUMP+(1:t.NUMA))) # these are the admixed target haplotypes
  {
    ...
    {
      tmpia<-sample(1:t.L,1,prob=sim.alpha[[ind]]) # sample an ancestry 
