...
m.args=add_argument(m.args, "--noPI", help="don't update copying matrix Mu via EM",flag=TRUE)
m.args=add_argument(m.args, "--norho", help="don't update copying matrix Mu via EM",flag=TRUE)
m.args=add_argument(m.args, "--notheta", help="don't update copying matrix Mu via EM",flag=TRUE)
